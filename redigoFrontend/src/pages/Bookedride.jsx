...
// Update getStatusColor function to handle more statuses
...
const getStatusIcon = (status) => {
 ...
 // Update the filteredRides logic to handle the new statuses
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b mt-10">
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
          {/* <div className="flex items-center justify-between h-16 pl-5 w-full "> */}
            {/* <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Manage your booked rides</p>
              </div>
            </div> */}
